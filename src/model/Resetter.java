...
public class Resetter implements Serializable {
	...
	// local consuctor for the resetter, takes a UserDatabase and a Songlibrary
	// for future use of resetting.
	...
	// if there is no resetter then it makes one and returns it otherwise it
	// returns the current resetter.
	...
	// checks to see if the day has changed and if so it will reset the values
	// in bot collections.
